...
private val FEW_SECOND = LongRange(ONE_SECOND.endInclusive + 1, 45L * 1000)
private val ONE_MINUTE = LongRange(FEW_SECOND.endInclusive + 1, 75L * 1000)
private val FEW_MINUTE = LongRange(ONE_MINUTE.endInclusive + 1, 45L * 60 * 1000)
private val ONE_HOUR = LongRange(FEW_MINUTE.endInclusive + 1, 75L * 60 * 1000)
private val FEW_HOUR = LongRange(ONE_HOUR.endInclusive + 1, 22L * 60 * 60 * 1000)
private val ONE_DAY = LongRange(FEW_HOUR.endInclusive + 1, 26L * 60 * 60 * 1000)
private val FEW_DAY = LongRange(ONE_DAY.endInclusive + 1, 360L * 24 * 60 * 60 * 1000)
private val ONE_YEAR = LongRange(FEW_DAY.endInclusive + 1, Long.MAX_VALUE)